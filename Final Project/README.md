...
## 👥 멤버 소개
- 김성현 : Java 비전공, Front : Main, MiniGame, Attend, Rank / Back : Board, Reply, Search, MiniGame
- 서근범 : Java 비전공, Front : Board, Routine, Login, Like(추천), Payments API / Back : User, User-info, Routine, MiniGame, Attend, Like
</br>
