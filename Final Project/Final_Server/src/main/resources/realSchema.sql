...
INSERT INTO `routine`
VALUES(0, "어깨", "덤벨 숄더 프레스", 3, 10);
INSERT INTO `routine`
VALUES(0, "팔", "덤벨 컬", 3, 12);
INSERT INTO `routine`
VALUES(0, "전완근", "팔굽혀펴기", 3, 12);
INSERT INTO `routine`
VALUES(0, "가슴", "바벨 벤치 프레스", 3, 10);
INSERT INTO `routine`
VALUES(0, "등", "렛 풀다운", 3, 10);
INSERT INTO `routine`
VALUES(0, "복근", "크런치", 3, 15);
INSERT INTO `routine`
VALUES(0, "하체", "레그 프레스", 3, 12);


INSERT INTO `routineboard` (`id`, `routine_id`, `title`, `writer`, `content`, `view_cnt`, `reg_date`, `like`)
VALUES(0, 1, "어깨 운동 참조 : GPT 프롬프트를 이용해 받아온 자료입니다. 초보 분들 참고하세요.", "관리자", "덤벨 숄더 프레스는 어깨 근육을 전체적으로 강화하는 데 효과적인 운동 중 하나입니다. 하지만 처음 시작하는 분들은 올바른 자세를 유지하는 것이 중요하며, 적절한 중량을 선택하여 시작하는 것이 좋습니다. 천천히 시작해서 기술을 익히고 나중에 중량을 조절해 나가세요.", 53, '2024-05-10', 0);
INSERT INTO `routineboard` (`id`, `routine_id`, `title`, `writer`, `content`, `view_cnt`, `reg_date`, `like`)
VALUES(0, 2, "팔 운동 참조 : GPT 프롬프트를 이용해 받아온 자료입니다. 초보 분들 참고하세요.", "관리자", "덤벨 컬은 주로 상완근 (상팔근)을 타겟으로 하며, 삼두근에도 일정 부분 작용합니다. 이 운동은 상완근을 강화하고 팔의 근육을 형성하는 데 도움이 됩니다. 천천히 시작해서 올바른 자세를 유지하고, 적절한 중량을 선택하여 시작하세요.", 67, '2024-05-10', 0);
INSERT INTO `routineboard` (`id`, `routine_id`, `title`, `writer`, `content`, `view_cnt`, `reg_date`, `like`)
VALUES(0, 3, "전완근 운동 참조 : GPT 프롬프트를 이용해 받아온 자료입니다. 초보 분들 참고하세요.", "관리자", "팔 굽혀펴기는 전완근을 주로 타겟으로 합니다. 이 운동은 팔의 뒷부분인 삼두근을 강화하고 발달시키는 데 효과적입니다. 천천히 시작하여 올바른 자세를 유지하고, 적절한 중량을 선택하여 시작하세요.", 53, '2024-05-10', 0);
INSERT INTO `routineboard` (`id`, `routine_id`, `title`, `writer`, `content`, `view_cnt`, `reg_date`, `like`)
VALUES(0, 4, "가슴 운동 참조 : GPT 프롬프트를 이용해 받아온 자료입니다. 초보 분들 참고하세요.", "관리자", "이 운동은 가슴 근육을 강화하는 데 효과적입니다. 하지만 처음 시작하는 분들은 적절한 중량과 기술에 집중하여 운동을 시작하는 것이 중요합니다. 천천히 시작해서 자신의 편안한 중량부터 시작하고, 올바른 자세를 유지하는 것이 중요해요.", 42, '2024-05-10', 0);
INSERT INTO `routineboard` (`id`, `routine_id`, `title`, `writer`, `content`, `view_cnt`, `reg_date`, `like`)
VALUES(0, 5, "등 운동 참조 : GPT 프롬프트를 이용해 받아온 자료입니다. 초보 분들 참고하세요.", "관리자", "렛 풀다운은 등의 근육을 강화하는 데 효과적인 운동 중 하나입니다. 이 운동은 더 강력하고 단단한 등을 만드는 데 도움이 됩니다. 천천히 시작하여 올바른 자세를 유지하고, 적절한 중량을 선택하여 시작하세요.", 85, '2024-05-10', 0);
INSERT INTO `routineboard` (`id`, `routine_id`, `title`, `writer`, `content`, `view_cnt`, `reg_date`, `like`)
VALUES(0, 6, "복근 운동 참조 : GPT 프롬프트를 이용해 받아온 자료입니다. 초보 분들 참고하세요.", "관리자", "크런치는 복근을 중심으로 작용하는 운동 중 하나입니다. 이 운동은 복부의 근육을 강화하고 팽팽하게 만드는 데 효과적입니다. 천천히 시작하여 올바른 자세를 유지하고, 적절한 횟수로 운동을 수행하세요. ", 32, '2024-05-10', 0);
INSERT INTO `routineboard` (`id`, `routine_id`, `title`, `writer`, `content`, `view_cnt`, `reg_date`, `like`)
VALUES(0, 7, "하체 운동 참조 : GPT 프롬프트를 이용해 받아온 자료입니다. 초보 분들 참고하세요.", "관리자", "레그 프레스는 대퇴사두근과 종아리 근육을 주로 타겟으로 하는 운동 중 하나입니다. 이 운동은 다리 근육을 강화하고 형태를 개선하는 데 효과적입니다. 천천히 시작하여 올바른 자세를 유지하고, 적절한 중량과 횟수로 운동을 수행하세요.", 16, '2024-05-10', 0);
